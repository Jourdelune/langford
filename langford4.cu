/* =====================================================================
 * langford4.cu -- Godfrey + full order-8 symmetry group + ZERO-TERM SKIP.
 *
...
template<int NN> struct fast_t { static kern_t get(){ return (kern_t)godfrey4<NN>; } };
template<> struct fast_t<32>   { static kern_t get(){ return (kern_t)godfrey3<32,false>; } };
#define INST(NN) case NN: return diag ? (kern_t)godfrey3<NN,true> : fast_t<NN>::get();
